...
**Beteiligte Parteien:**
- **Fördernehmer** (Unternehmen/Kunde)
- **Förderstelle** (WK Tirol)
- **Berater** (Beratungsunternehmen)

**Ablauf:**

| Schritt | Aktion | Von → An |
|---------|--------|----------|
| 1 | **Ansuchen einreichen** | Fördernehmer → WK Tirol |
| 2 | **Prüfung der Unterlagen** | WK Tirol |
| 3 | **Auftragsschreiben versenden** | WK Tirol → Fördernehmer + Berater |
| 4 | **Beratung durchführen** | Berater |
| 5 | **Abschluss & Dokumentation** | Berater → WK Tirol |
| 6 | **Prüfung der Abrechnung** | WK Tirol |
| 7 | **Weiterleitung an Kunden** | WK Tirol → Fördernehmer |
| 8 | **Zahlung an Berater + Nachweis** | Fördernehmer → Berater, dann Nachweis → WK Tirol |
| 9 | **Förderung auszahlen** | WK Tirol → Fördernehmer |
